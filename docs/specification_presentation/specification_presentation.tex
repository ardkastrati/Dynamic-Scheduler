...
\section{Introduction}
	\begin{frame}{Introduction}
		\begin{itemize}
			\pause
			\item User-friendly middle ware between scientific simulation and HPC
			\pause
			\item Runtime administration service for scientific simulations
			\pause
			\item Manages large amount of individual task
			\pause
...
\section{Most important features}
	\begin{frame}{Most important features}
		\begin{itemize}
			\pause
			\item Usable with several scientific codes
			\pause
			\item Scheduling	
				\begin{itemize}
					\item Support of several scheduling architecture and strategies
