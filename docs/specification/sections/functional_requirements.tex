...
\section{Functional requirements} 
	...
	\subsubsection{Scheduler}
		...
		\begin{itemize}
			...
			\item Dequeue task from the scheduling queue% Delete or remove 
	...
	\subsubsection{Database}
		...
		\subsubsection{Data mining}
			...
			\begin{itemize}
				\item Read data from statistics database %TODO database????
				\item Write data into statistics database%TODO database????
	...
	\subsection{Functions required for optional features}
		...
		\begin{itemize}
			...
			\item Possibility to import an already used statistic file%TODO 	must-have
