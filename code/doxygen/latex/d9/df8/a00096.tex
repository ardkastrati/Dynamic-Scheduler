\hypertarget{a00096}{}\subsection{Worker\+Executor Class Reference}
\label{a00096}\index{Worker\+Executor@{Worker\+Executor}}
...
First the executor() function calls \hyperlink{a00096_ac3155d06d7807a1d9d305293b92d63ab}{preprocessing()}. After that the executor() functions calls the wait\+\_\+for\+\_\+worker() function. This function blocks until a new M\+P\+I message receive, and starts the computation. This is repeated until the worker receives a M\+P\+I massage with the tag S\+T\+O\+P. At the end the executor() function calls the \hyperlink{a00096_aff4c1b156960d031d09e669014038cd5}{postprocessing()} function.
...
\hypertarget{a00096_aae5a80d4f64f2bc795b175697e15225f}{}\index{Worker\+Executor@{Worker\+Executor}!Worker\+Executor@{Worker\+Executor}}
...
)}\label{a00096_aae5a80d4f64f2bc795b175697e15225f}
Constructs a new \hyperlink{a00096}{Worker\+Executor} object. This constructor calls the super constructor from \hyperlink{a00027}{Executor}.
...
\hypertarget{a00096_adb37338d137f4039d835519b14698d51}{}\index{Worker\+Executor@{Worker\+Executor}!execute@{execute}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00096_adb37338d137f4039d835519b14698d51}
...
\hypertarget{a00096_a50f9307b592bb371535e00461d7d0133}{}\index{Worker\+Executor@{Worker\+Executor}!place\+\_\+task@{place\+\_\+task}}
...
\item[{{\bf Task}}]{task}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00096_a50f9307b592bb371535e00461d7d0133}
...
\hypertarget{a00096_aff4c1b156960d031d09e669014038cd5}{}\index{Worker\+Executor@{Worker\+Executor}!postprocessing@{postprocessing}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00096_aff4c1b156960d031d09e669014038cd5}
...
\hypertarget{a00096_ac3155d06d7807a1d9d305293b92d63ab}{}\index{Worker\+Executor@{Worker\+Executor}!preprocessing@{preprocessing}}
...
\item[{char $\ast$}]{argv\mbox{[}$\,$\mbox{]}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00096_ac3155d06d7807a1d9d305293b92d63ab}
Calls the code\+\_\+preprocessing\+\_\+slave() function of the scientific code and pass the command lines arguments. When the code\+\_\+preprocessing\+\_\+slave() function returns, a M\+P\+I message with the T\+A\+G F\+I\+N\+I\+S\+H will be send to the \hyperlink{a00051}{Master} (rank 0).
...
\hypertarget{a00096_a7edee52a5d96dea5da7dc0e0ba461b45}{}\index{Worker\+Executor@{Worker\+Executor}!run\+\_\+task@{run\+\_\+task}}
...
\item[{{\bf Task}}]{task}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\label{a00096_a7edee52a5d96dea5da7dc0e0ba461b45}
Calls the code\+\_\+run\+\_\+task() function of the scientific and starts the scientific calculation with the given task. If the computation finish, a M\+P\+I message with the T\+A\+G finish will be send to the \hyperlink{a00051}{Master} (rank 0).
